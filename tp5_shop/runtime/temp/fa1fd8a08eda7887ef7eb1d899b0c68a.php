...
<article class="page-container">
    ...
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2">分类：</label>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-4">
				<input type="text" class="input-text" name="title" value="<?php echo htmlentities($info['title']); ?>">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">排序：</label>
			<div class="formControls col-xs-8 col-sm-4">
				<input type="text" class="input-text" value="<?php echo htmlentities($info['sort']); ?>" name="sort">
		  </div>
    </div>
    <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>价格：</label>
			<div class="formControls col-xs-8 col-sm-4">
				<input type="text" class="input-text" name="price" value="<?php echo htmlentities($info['price']); ?>">
			</div>
    </div>
    <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red" >*</span>库存：</label>
			<div class="formControls col-xs-8 col-sm-4">
				<input type="text" class="input-text" name="sku" value="<?php echo htmlentities($info['sku']); ?>">
			</div>
    </div>
    <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>浏览次数：</label>
			<div class="formControls col-xs-8 col-sm-4">
				<input type="text" class="input-text" name="views" value="<?php echo htmlentities($info['views']); ?>">
			</div>
    </div>
    <div class="row cl">
    ...
    <div class="row cl">
            ...
            <div class="layui-upload col-sm-4">
                ...
                <div class="layui-upload-list">
                    <img src="<?php echo url($info['img']); ?>" style="width:200px;" class="layui-upload-img" id="demo1">
                    <p id="demoText"></p>
                </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-4">
        <textarea cols="" rows="" class="textarea" name="intru" ><?php echo htmlentities($info['intru']); ?></textarea>
      </div>
    </div>
    <div class="row cl">
