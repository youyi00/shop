...
<article class="page-container">
    ...
    <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-4">
				<input type="text" class="input-text" name="sku">
			</div>
    </div>
    <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>浏览次数：</label>
			<div class="formControls col-xs-8 col-sm-4">
				<input type="text" class="input-text" name="views">
			</div>
    </div>
    <div class="row cl">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-4">
        <textarea cols="" rows="" class="textarea" name="intru"></textarea>
      </div>
    </div>
    <div class="row cl">
