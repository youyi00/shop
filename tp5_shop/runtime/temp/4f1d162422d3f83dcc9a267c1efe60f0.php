...
<article class="page-container">
	<form class="form" action="<?php echo url('save'); ?>">
    <input type="hidden" name="id" value="<?php echo htmlentities($info['id']); ?>" />
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-4">
				<input type="text" class="input-text" name="sort" value="<?php echo htmlentities($info['sort']); ?>">
			</div>
        </div>
        <div class="row cl">
            ...
            <div class="layui-upload col-sm-4">
                ...
                <div class="layui-upload-list">
                    ...
                    <p id="demoText"></p>
                    <!-- <img src="<?php echo url($info['img']); ?>" style="width:200px;" class="layui-upload-img"> -->
                </div>
